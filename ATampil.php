...
?>
              ...
              <div class="card-tools">
                ...
                <button type="button" class="btn bg-gradient-secondary"><a href="ATambah.php">Tambah</a></button>
</div>
              <!-- /.card-header -->
    ...
    while ($dataTanggapan = mysqli_fetch_array($sqlTanggapan, MYSQLI_ASSOC)){
        ...
        <td>
        <a href="AEdit.php?id_tanggapan=' . $dataTanggapan['id_tanggapan'].'" class="btn btn-dark">Edit</a>
        <a href="AHapus.php?id_tanggapan=' . $dataTanggapan['id_tanggapan'].'" class="btn btn-dark">Hapus</a>
        </td>
        </tr>';
    }
    ?>
