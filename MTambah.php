      ...
      <div class="container-fluid">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="MSimpan.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputidpengaduan">ID Pengaduan</label>
                    <input type="text" class="form-control" name="txtIP" placeholder="Masukkan ID Pengaduan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputTglPengaduan">TGL Pengaduan</label>
                    <input type="date" class="form-control" name="txtTP" placeholder="Masukkan TGL Pengaduan">
                  </div>
                  <div class="form-group">
                  <label>NIK</label>
                        <select class="form-control" name="nik">
                          ...
                          <?php 
                          include('Koneksi.php');
                          $sql = mysqli_query($kon, "SELECT * FROM masyarakat");
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtIL" placeholder="Masukkan Isi Laporan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputfoto">Foto</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="txtF">
